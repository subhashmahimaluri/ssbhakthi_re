...
export default function SahasranamavaliStotraPage() {
  ...
  const fetchStotra = useCallback(async () => {
    ...
    try {
      ...
      console.error('Error fetching sahasranamavali stotra:', err);
  ...
  if (!router.isReady || loading) {
    return (
      <Layout title="Loading Sahasranamavali | SS Bhakthi">
  ...
  if (error && !loading) {
    return (
      <Layout title="Error Loading Sahasranamavali | SS Bhakthi">
        <Row className="mt-25 py-5">
          <Col xl="8" lg="8" md="12" className="my-5 py-5">
            <div className="left-container shadow-1 px-md-10 bg-white px-5 py-5 text-black">
              ...
              <div className="mt-3 text-center">
                ...
                <button
                  ...
                  onClick={() => router.push('/sahasranamavali')}
                >
                  Back to Sahasranamavali Collection
                </button>
              </div>
            </div>
          </Col>
  ...
  if (!stotra && !loading && !error) {
    return (
      <Layout title="Sahasranamavali Not Found | SS Bhakthi">
        <Row className="mt-25 py-5">
          <Col xl="8" lg="8" md="12" className="my-5 py-5">
            <div className="left-container shadow-1 px-md-10 bg-white px-5 py-5 text-black">
              <div className="alert alert-warning" role="alert">
                Sahasranamavali not found or failed to load.
              </div>
              <div className="mt-3 text-center">
                ...
                <button
                  ...
                  onClick={() => router.push('/sahasranamavali')}
                >
                  Browse Sahasranamavali Collection
                </button>
              </div>
            </div>
          </Col>
  ...
  const { title } = translation?.seoTitle
    ...
    : { title: 'Sahasranamavali | SS Bhakthi' };
      ...
      <Layout title="Translation Not Available | SS Bhakthi">
        <Row className="mt-25 py-5">
          <Col xl="8" lg="8" md="12" className="my-5 py-5">
            <div className="left-container shadow-1 px-md-10 bg-white px-5 py-5 text-black">
              <div className="alert alert-warning" role="alert">
                Translation data not available for this Sahasranamavali.
              </div>
              <div className="mt-3 text-center">
                <button className="btn btn-primary me-2" onClick={() => fetchStotra()}>
                  Retry
      ...
      <Row className="mt-25 py-5">
            ...
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                <li className="breadcrumb-item">
                  <Link href="/sahasranamavali" className="text-decoration-none">
                    Sahasranamavali
                  </Link>
                </li>
        ...
        <Col xl="4" lg="4" md="12" className="my-5 py-5">
          <div className="right-container shadow-1 mb-3 bg-white px-3 py-3 text-black">
            <h2>About Sahasranamavali</h2>
            <p className="text-muted small">
              <strong>Sahasranamavali</strong> refers to the 1000 sacred names of various deities.
              Each collection contains divine names that are chanted for devotion and spiritual
              benefit.
            </p>
            ...
            <div className="d-grid gap-2">
              <Link href="/sahasranamavali" className="btn btn-outline-secondary btn-sm">
                ← Back to Collection
              </Link>
            </div>
          </div>
