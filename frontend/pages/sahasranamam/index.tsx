...
export default function Sahasranamam() {
  ...
  // Sahasranama category ID from database
  const SAHASRANAMA_CATEGORY_ID = '68dce4a832e525e497f29abc'; // General Sahasranama category
      ...
      <Row className="mt-25 py-5">
        <Col xl="8" lg="8" md="12" className="my-5 py-5">
          <div className="left-container shadow-1 panchangam-block px-md-10 bg-white px-5 py-3 text-black">
            <h1 className="text-center">Sahasranamam</h1>
            <p className="text-center">Collection of 1000 names of deities in hymn form</p>
        ...
        <Col xl="4" lg="4" md="12" className="my-5 py-5">
          <div className="right-container shadow-1 mb-3 bg-white px-3 py-3 text-black">
            ...
            <p className="text-muted">
              Sahasranamam refers to the 1000 sacred names of various deities in hymn form. Each
