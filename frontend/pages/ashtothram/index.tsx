...
export default function Ashtothram() {
  ...
  const ASHTOTTARA_CATEGORY_ID = '68ac2239bfcc70ec4468aa8c';
  ...
  const fetchStotras = async (page: number = 1, reset: boolean = false) => {
    try {
      ...
      const apiUrl = `http://localhost:4000/rest/stotras?lang=${locale}&page=${page}&limit=${ITEMS_PER_PAGE}&categoryId=${ASHTOTTARA_CATEGORY_ID}`;
      ...
      <Row className="mt-25 py-5">
        <Col xl="8" lg="8" md="12" className="my-5 py-5">
          <div className="left-container shadow-1 panchangam-block px-md-10 bg-white px-5 py-3 text-black">
            <h1 className="text-center">Ashtottara Shatanamavali</h1>
            <p className="text-center">Collection of 108 names of deities</p>
        ...
        <Col xl="4" lg="4" md="12" className="my-5 py-5">
          <div className="right-container shadow-1 mb-3 bg-white px-3 py-3 text-black">
            ...
            <p className="text-muted">
              Ashtottara Shatanamavali refers to the 108 sacred names of various deities. Each
