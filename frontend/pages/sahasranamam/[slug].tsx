...
export default function SahasranamamStotraPage() {
  ...
  const fetchStotra = useCallback(async () => {
    ...
    try {
      ...
      console.log('Fetching sahasranamam stotra from:', apiUrl);
      ...
      console.error('Error fetching sahasranamam stotra:', err);
  ...
  if (!router.isReady || loading) {
    return (
      <Layout title="Loading Sahasranamam | SS Bhakthi">
  ...
  if (error && !loading) {
    return (
      <Layout title="Error Loading Sahasranamam | SS Bhakthi">
        <Row className="mt-25 py-5">
          <Col xl="8" lg="8" md="12" className="my-5 py-5">
            <div className="left-container shadow-1 px-md-10 bg-white px-5 py-5 text-black">
              ...
              <div className="mt-3 text-center">
                ...
                <button className="btn btn-secondary" onClick={() => router.push('/sahasranamam')}>
                  Back to Sahasranamam Collection
                </button>
              </div>
            </div>
          </Col>
  ...
  if (!stotra && !loading && !error) {
    return (
      <Layout title="Sahasranamam Not Found | SS Bhakthi">
        <Row className="mt-25 py-5">
          <Col xl="8" lg="8" md="12" className="my-5 py-5">
            <div className="left-container shadow-1 px-md-10 bg-white px-5 py-5 text-black">
              <div className="alert alert-warning" role="alert">
                Sahasranamam not found or failed to load.
              </div>
              <div className="mt-3 text-center">
                ...
                <button className="btn btn-secondary" onClick={() => router.push('/sahasranamam')}>
                  Browse Sahasranamam Collection
                </button>
              </div>
            </div>
          </Col>
      ...
      <Layout title="Translation Not Available | SS Bhakthi">
        <Row className="mt-25 py-5">
          <Col xl="8" lg="8" md="12" className="my-5 py-5">
            <div className="left-container shadow-1 px-md-10 bg-white px-5 py-5 text-black">
              <div className="alert alert-warning" role="alert">
                Translation data not available for this Sahasranamam.
              </div>
              <div className="mt-3 text-center">
                <button className="btn btn-primary me-2" onClick={() => fetchStotra()}>
                  Retry
      ...
      <Row className="mt-25 py-5">
            ...
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                <li className="breadcrumb-item">
                  <Link href="/sahasranamam" className="text-decoration-none">
                    Sahasranamam
                  </Link>
                </li>
        ...
        <Col xl="4" lg="4" md="12" className="my-5 py-5">
          <div className="right-container shadow-1 mb-3 bg-white px-3 py-3 text-black">
            <h2>About Sahasranamam</h2>
            <p className="text-muted small">
              <strong>Sahasranamam</strong> refers to the 1000 sacred names of various deities. Each
              collection contains divine names that are chanted for devotion and spiritual benefit.
            </p>
            ...
            <div className="d-grid gap-2">
              <Link href="/sahasranamam" className="btn btn-outline-secondary btn-sm">
                ← Back to Collection
              </Link>
            </div>
          </div>
