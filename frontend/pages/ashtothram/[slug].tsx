...
export default function AshtothramStotraPage() {
  ...
  const fetchStotra = useCallback(async () => {
    ...
    try {
      ...
      console.log('Fetching ashtothram stotra from:', apiUrl);
      ...
      console.error('Error fetching ashtothram stotra:', err);
  ...
  if (!router.isReady || loading) {
    return (
      <Layout title="Loading Ashtottara Shatanamavali | SS Bhakthi">
  ...
  if (error && !loading) {
    return (
      <Layout title="Error Loading Ashtottara Shatanamavali | SS Bhakthi">
        <Row className="mt-25 py-5">
          <Col xl="8" lg="8" md="12" className="my-5 py-5">
            <div className="left-container shadow-1 px-md-10 bg-white px-5 py-5 text-black">
              ...
              <div className="mt-3 text-center">
                ...
                <button className="btn btn-secondary" onClick={() => router.push('/ashtothram')}>
                  Back to Ashtottara Collection
                </button>
              </div>
            </div>
          </Col>
  ...
  if (!stotra && !loading && !error) {
    return (
      <Layout title="Ashtottara Shatanamavali Not Found | SS Bhakthi">
        <Row className="mt-25 py-5">
          <Col xl="8" lg="8" md="12" className="my-5 py-5">
            <div className="left-container shadow-1 px-md-10 bg-white px-5 py-5 text-black">
              <div className="alert alert-warning" role="alert">
                Ashtottara Shatanamavali not found or failed to load.
              </div>
              <div className="mt-3 text-center">
  ...
  const { title } = translation?.seoTitle
    ...
    : { title: 'Ashtottara Shatanamavali | SS Bhakthi' };
      ...
      <Layout title="Translation Not Available | SS Bhakthi">
        <Row className="mt-25 py-5">
          <Col xl="8" lg="8" md="12" className="my-5 py-5">
            <div className="left-container shadow-1 px-md-10 bg-white px-5 py-5 text-black">
              <div className="alert alert-warning" role="alert">
                Translation data not available for this Ashtottara Shatanamavali.
              </div>
              <div className="mt-3 text-center">
                <button className="btn btn-primary me-2" onClick={() => fetchStotra()}>
                  Retry
      ...
      <Row className="mt-25 py-5">
            ...
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                <li className="breadcrumb-item">
                  <Link href="/ashtothram" className="text-decoration-none">
        ...
        <Col xl="4" lg="4" md="12" className="my-5 py-5">
          <div className="right-container shadow-1 mb-3 bg-white px-3 py-3 text-black">
            <h2>About Ashtottara Shatanamavali</h2>
            <p className="text-muted small">
              <strong>Ashtottara Shatanamavali</strong> refers to the 108 sacred names of various
              deities. Each collection contains divine names that are chanted for devotion and
              spiritual benefit.
            </p>
            ...
            <div className="d-grid gap-2">
              <Link href="/ashtothram" className="btn btn-outline-secondary btn-sm">
                ← Back to Collection
              </Link>
            </div>
          </div>
