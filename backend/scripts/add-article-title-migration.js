...
async function connectToDatabase() {
  try {
    const mongoUri =
      ...
      'mongodb://admin:devpassword123@localhost:27017/ssbhakthi_api?authSource=admin';
...
async function addArticleTitleToExistingArticles() {
  try {
    ...
    const articles = await contentsCollection
      .find({
        contentType: 'article',
...
module.exports = { addArticleTitleToExistingArticles };
